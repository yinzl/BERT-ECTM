...
parser.add_argument('--epochs', type=int, default=400, help='number of epochs to train...150 for 20ng 100 for others')
...
def visualize(m, show_emb=True):
    ...
    queries = ["诈骗","杀人", "驾驶", "拘留", "盗窃", "死亡", "抢夺", "赌博", "伤害", "非法占有", "吸毒", "强奸"]
