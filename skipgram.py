...
parser.add_argument('--data_file', type=str, default='D:\ETM-master\scripts\law_docs.txt', help='a .txt file containing the corpus')
...
model = gensim.models.Word2Vec(sentences, min_count=args.min_count, sg=args.sg, vector_size=args.dim_rho,
    workers=args.workers, negative=args.negative_samples, window=args.window_size)
